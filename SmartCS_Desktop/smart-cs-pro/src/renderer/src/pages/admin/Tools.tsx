      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
         <div className="bg-white p-8 rounded-xl border border-slate-200 shadow-sm group hover:border-cyan-500/30 transition-all">
            ...
            <button 
              ...
              disabled={loading}
              className="w-full py-4 bg-slate-900 text-white rounded-xl text-xs font-black uppercase tracking-widest shadow-xl active:scale-95 hover:bg-slate-800 transition-all flex items-center justify-center gap-3 disabled:opacity-50"
            >
