            ...
            {showSearch && (
              <div className="relative mb-1.5 p-1">
                ...
                <input 
                  ...
                  placeholder="检索匹配项..."
                  className="w-full pl-8 pr-3 py-1.5 bg-slate-50 border-none rounded-xl text-[11px] font-bold text-slate-900 focus:ring-0 shadow-inner"
                />
              </div>
            )}
              ...
              {filteredOptions.length === 0 ? (
                ...
                filteredOptions.map((opt) => (
                  <div 
                    ...
                    className={cn(
                      "px-3 py-2 rounded-xl text-[11px] font-black flex items-center justify-between cursor-pointer transition-all mb-0.5 last:mb-0",
