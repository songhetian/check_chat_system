...
('admin:sentiment:view', '情绪标签查看', 'AI 策略中心'),
('admin:sentiment:create', '新增情绪标签', 'AI 策略中心'),
('admin:sentiment:update', '编辑情绪标签', 'AI 策略中心'),
('admin:sentiment:delete', '移除情绪标签', 'AI 策略中心'),
('admin:dept_word:view', '规避词库查看', '合规中心'),
('admin:dept_word:create', '新增规避词', '合规中心'),
